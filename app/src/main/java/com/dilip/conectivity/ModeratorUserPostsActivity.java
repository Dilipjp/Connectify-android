...
public class ModeratorUserPostsActivity extends AppCompatActivity {

    private RecyclerView recyclerViewUserPosts;
    private List<Post> postList;
    private ModeratorUserPostAdapter userPostAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        userPostAdapter = new ModeratorUserPostAdapter(this, postList);
    ...
    private void loadUserPosts() {
        ...
        postsRef.orderByChild("userId").equalTo(userId).addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(ModeratorUserPostsActivity.this, "Failed to load posts.", Toast.LENGTH_SHORT).show();
            }
        });
    }
}
